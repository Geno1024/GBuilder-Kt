package com.geno1024.gbuilder.db

import com.geno1024.gbuilder.db.structures.Repo
...
object DBIO
{
    ...
    fun init()
    {
        transaction {
            ...
            Schema("gbuilder").apply {
                SchemaUtils.dropSchema(this)
                SchemaUtils.createSchema(this)
                SchemaUtils.setSchema(this)
            }
            SchemaUtils.drop(User, Repo)
            SchemaUtils.create(User, Repo)
        }
    }
}
/**
